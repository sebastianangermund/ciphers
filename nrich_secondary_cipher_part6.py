"""https://nrich.maths.org/special

Here there is no guessing. We were given a hint that the keyword is a mathematical shape,
so implement the solver and have the computer go at it.
"""
...
cipher = encode('encode this', keyword_list[0])
