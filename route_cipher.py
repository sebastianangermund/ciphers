...
"""To solve a route cipher, only change the variable "cipher". The rest is automatically done and the result
printed out to a file "Output.txt" for every possible block size (starting at each corner in both directions.)
...
# cipher = 'EJXCTEDECDAEWRIORFEONALEVSE'	# test cipher
...
def dictify(cipher, dim, corner, direction):
	r, c = dim
